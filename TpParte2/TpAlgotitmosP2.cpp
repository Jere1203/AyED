...
int main()
{
    ...
    {
        for(int j=0; j<4; j++) {
            MatPedidos[i][j].pri=NULL;
            MatPedidos[i][j].ult=NULL;
        }
    }
    do
    {
        ...
        switch (menu)
        {
            ...
            case 2:
                ...
                if(OpcionDos(rep))
                {
                    //cout<<endl<<endl<<rep.transporte<<endl<<endl;
                    if(MatPedidos[rep.codZona-1][rep.transporte-1].ult!=NULL)
                    {
                        desencolar(MatPedidos[rep.codZona-1][rep.transporte-1].pri, MatPedidos[rep.codZona-1][rep.transporte-1].ult, ped);
...
void pedirDatos (Pedidos&ped)
{
    ...
    while(true)
    {
        if(!LeerFloat(ped.importe ) || (ped.importe < 0))
...
int tipoVehiculo(float vol) 
{
    ...
    if(vol<0.005) return 0;
    if(vol>=0.005 && vol<0.02) return 1;
    if(vol>=0.02 && vol<8) return 2;
    else return 3;
}
...
void ListaRepartidores(listaRep*&lista, repartidores repartidor, Pedidos pedido)
{
    ...
    {
        sublistaRepartidores(p->ordenes, pedido);
    }
    else 
    {
        ...
        if(p!=lista)
            ...
            lista=n; 
        sublistaRepartidores(n->ordenes, pedido);
    }
}
...
void RecorrerListaySub (listaRep*lista){
    ...
    while (p!= NULL)
    {
        ...
        switch (p->info.transporte)
        {
            case 1:
                cout <<"Transporte: Moto"<<endl;
                break;
            case 2:
                cout<<"Tranasporte: Auto"<<endl;
                break;
            case 3:
                cout<<"Transporte: Camioneta"<<endl;
                break;
            case 4:
                cout<<"Transporte: Camion"<<endl;
                break;
        }
        cout <<"Codigo de Zona: " << p->info.codZona << endl;
...
void listarIn(arbol*raiz)
{
   if(raiz!=NULL)
   {
        ...
        cout<<"Comercio: "<<raiz->data.codComercio <<"  ";
        cout<<"Cant: "<<raiz->data.cant <<"  "<<endl;
